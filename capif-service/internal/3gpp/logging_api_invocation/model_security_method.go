...
// SecurityMethod Indicates the security method.   Possible values are: - PSK: Security method 1 (Using TLS-PSK) as described in 3GPP TS 33.122. - PKI: Security method 2 (Using PKI) as described in 3GPP TS 33.122. - OAUTH: Security method 3 (TLS with OAuth token) as described in 3GPP TS 33.122.

...
// APIClient manages communication with the CAPIF_API_Provider_Management_API API v1.2.0-alpha.3
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.IndividualAPIProviderEnrolmentDetailsAPI = (*IndividualAPIProviderEnrolmentDetailsAPIService)(&c.common)

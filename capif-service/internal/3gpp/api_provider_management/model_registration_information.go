...
type _RegistrationInformation RegistrationInformation
...
func (o *RegistrationInformation) UnmarshalJSON(data []byte) (err error) {
	...
	varRegistrationInformation := _RegistrationInformation{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRegistrationInformation)

	if err != nil {
		return err
	}

	*o = RegistrationInformation(varRegistrationInformation)

...
type ServiceAPIDescription struct {
	...
	// A string used to indicate the features supported by an API that is used as defined in clause  6.6 in 3GPP TS 29.500. The string shall contain a bitmask indicating supported features in  hexadecimal representation Each character in the string shall take a value of \"0\" to \"9\",  \"a\" to \"f\" or \"A\" to \"F\" and shall represent the support of 4 features as described in  table 5.2.2-3. The most significant character representing the highest-numbered features shall  appear first in the string, and the character representing features 1 to 4 shall appear last  in the string. The list of features and their numbering (starting with 1) are defined  separately for each API. If the string contains a lower number of characters than there are  defined features for an API, all features that would be represented by characters that are not  present in the string are not supported.
	ApiSuppFeats *string           `json:"apiSuppFeats,omitempty" validate:"regexp=^[A-Fa-f0-9]*$"`
...
type _ServiceAPIDescription ServiceAPIDescription
...
// GetApiStatus returns the ApiStatus field value if set, zero value otherwise.
func (o *ServiceAPIDescription) GetApiStatus() ApiStatus {
	if o == nil || IsNil(o.ApiStatus) {
		var ret ApiStatus
		return ret
	}
	return *o.ApiStatus
...
// GetApiStatusOk returns a tuple with the ApiStatus field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ServiceAPIDescription) GetApiStatusOk() (*ApiStatus, bool) {
	if o == nil || IsNil(o.ApiStatus) {
		return nil, false
	}
	return o.ApiStatus, true
}

// HasApiStatus returns a boolean if a field has been set.
func (o *ServiceAPIDescription) HasApiStatus() bool {
	if o != nil && !IsNil(o.ApiStatus) {
		return true
	}
...
// SetApiStatus gets a reference to the given ApiStatus and assigns it to the ApiStatus field.
func (o *ServiceAPIDescription) SetApiStatus(v ApiStatus) {
	o.ApiStatus = &v
}
...
func (o *ServiceAPIDescription) GetApiProvName() string {
...
// and a boolean to check if the value has been set.
func (o *ServiceAPIDescription) GetApiProvNameOk() (*string, bool) {
	if o == nil || IsNil(o.ApiProvName) {
		return nil, false
	}
...
func (o *ServiceAPIDescription) HasApiProvName() bool {
	if o != nil && !IsNil(o.ApiProvName) {
		return true
	}
...
func (o *ServiceAPIDescription) SetApiProvName(v string) {
	o.ApiProvName = &v
}
...
func (o ServiceAPIDescription) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ApiStatus) {
		toSerialize["apiStatus"] = o.ApiStatus
	}
...
func (o *ServiceAPIDescription) UnmarshalJSON(data []byte) (err error) {
	...
	varServiceAPIDescription := _ServiceAPIDescription{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varServiceAPIDescription)

	if err != nil {
		return err
	}

	*o = ServiceAPIDescription(varServiceAPIDescription)

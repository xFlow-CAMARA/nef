...
// DataFormat Indicates a data format.   Possible values are: - JSON: Indicates that the data format is JSON. - XML: Indicates that the data format is Extensible Markup Language. - PROTOBUF3: Indicates that the data format is Protocol buffers version 3.

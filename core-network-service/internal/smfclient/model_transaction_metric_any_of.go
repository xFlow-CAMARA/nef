...
const (
	TRANSACTIONMETRICANYOF_EST   TransactionMetricAnyOf = "PDU_SES_EST"
	TRANSACTIONMETRICANYOF_AUTH  TransactionMetricAnyOf = "PDU_SES_AUTH"
	TRANSACTIONMETRICANYOF_MODIF TransactionMetricAnyOf = "PDU_SES_MODIF"
	TRANSACTIONMETRICANYOF_REL   TransactionMetricAnyOf = "PDU_SES_REL"
)

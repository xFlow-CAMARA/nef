...
const (
	DNAICHANGETYPEANYOF_EARLY      DnaiChangeTypeAnyOf = "EARLY"
	DNAICHANGETYPEANYOF_EARLY_LATE DnaiChangeTypeAnyOf = "EARLY_LATE"
	DNAICHANGETYPEANYOF_LATE       DnaiChangeTypeAnyOf = "LATE"
)

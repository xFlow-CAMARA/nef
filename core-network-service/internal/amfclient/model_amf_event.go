...
func NewAmfEvent(type_ AmfEventTypeAnyOf) *AmfEvent {
	this := AmfEvent{}
	this.Type = type_
	immediateFlag := false
	this.ImmediateFlag = &immediateFlag
	reportUeReachable := false
...
func (o *AmfEvent) GetType() AmfEventTypeAnyOf {
	if o == nil {
...
func (o *AmfEvent) GetTypeOk() (*AmfEventTypeAnyOf, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Type, true
...
func (o *AmfEvent) SetType(v AmfEventTypeAnyOf) {
	o.Type = v
}
...
func (o *AmfEvent) GetLocationFilterList() []LocationFilter {
	if o == nil || o.LocationFilterList == nil {
...
func (o *AmfEvent) GetTrafficDescriptorList() []TrafficDescriptor {
	if o == nil || o.TrafficDescriptorList == nil {
...
func (o *AmfEvent) GetReportUeReachable() bool {
	if o == nil || o.ReportUeReachable == nil {
		var ret bool
		return ret
	}
...
func (o *AmfEvent) GetReachabilityFilter() ReachabilityFilter {
	if o == nil || o.ReachabilityFilter == nil {
...
func (o *AmfEvent) GetPresenceInfoList() map[string]PresenceInfo {
	if o == nil || o.PresenceInfoList == nil {
...
func (o AmfEvent) MarshalJSON() ([]byte, error) {
	...
	if o.SnssaiFilter != nil {
		toSerialize["snssaiFilter"] = o.SnssaiFilter
	}
	if o.UeInAreaFilter != nil {

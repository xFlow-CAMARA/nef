...
func (o *AmfEventSubscription) GetSubsChangeNotifyUri() string {
	if o == nil || o.SubsChangeNotifyUri == nil {
		var ret string
		return ret
	}
...
func (o *AmfEventSubscription) GetExcludeSupiList() []string {
	if o == nil || o.ExcludeSupiList == nil {
		var ret []string
		return ret
	}
...
func (o *AmfEventSubscription) GetIncludeSupiList() []string {
	if o == nil || o.IncludeSupiList == nil {
		var ret []string
		return ret
	}

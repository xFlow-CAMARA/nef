...
type AmfEventReport struct {
	Type  AmfEventTypeAnyOf `json:"type"`
	...
	// Added to find the correspondance between AMF and RAN UE NGAP Id's
	AmfUeNgapId *int64  `json:"amfUeNgapId,omitempty"`
	RanUeNgapId *uint32 `json:"ranUeNgapId,omitempty"`
}
...
func NewAmfEventReport(type_ AmfEventTypeAnyOf, state AmfEventState, timeStamp time.Time) *AmfEventReport {
	this := AmfEventReport{}
	this.Type = type_
	this.State = state
...
func (o *AmfEventReport) GetType() AmfEventTypeAnyOf {
	if o == nil {
		var ret AmfEventTypeAnyOf
		return ret
	}
...
func (o *AmfEventReport) GetTypeOk() (*AmfEventTypeAnyOf, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Type, true
...
func (o *AmfEventReport) SetType(v AmfEventTypeAnyOf) {
	o.Type = v
}
...
func (o *AmfEventReport) GetAdditionalLocation() UserLocation {
	if o == nil || o.AdditionalLocation == nil {
		var ret UserLocation
		return ret
	}
...
func (o *AmfEventReport) GetLossOfConnectReason() LossOfConnectivityReason {
	if o == nil || o.LossOfConnectReason == nil {
...
func (o *AmfEventReport) GetVar5gsUserStateList() []Model5GsUserStateInfo {
	if o == nil || o.Var5gsUserStateList == nil {
...
func (o *AmfEventReport) GetUeAccessBehaviorTrends() []UeAccessBehaviorReportItem {
	if o == nil || o.UeAccessBehaviorTrends == nil {
...
func (o *AmfEventReport) GetUeLocationTrends() []UeLocationTrendsReportItem {
	if o == nil || o.UeLocationTrends == nil {
...
func (o *AmfEventReport) GetMmTransLocationReportList() []MmTransactionLocationReportItem {
	if o == nil || o.MmTransLocationReportList == nil {
...
func (o *AmfEventReport) GetMmTransSliceReportList() []MmTransactionSliceReportItem {
	if o == nil || o.MmTransSliceReportList == nil {
...
func (o AmfEventReport) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["timeStamp"] = o.TimeStamp.Unix() // added
	}
...
func (v NullableAmfEventReport) MarshalJSON() ([]byte, error) {
	...
	type AmfEventReportAlias AmfEventReport
	return json.Marshal(&struct {
		TimeStamp int64 `json:"timeStamp"`
		*AmfEventReportAlias
	}{
		AmfEventReportAlias: (*AmfEventReportAlias)(v.value),
...
func (v *NullableAmfEventReport) UnmarshalJSON(src []byte) error {
	...
	// custom unmarshaling for timestamp: int64 (as used in AMF) => time.Time
	type AmfEventReportAlias AmfEventReport
	alias := &struct {
		TimeStamp int64 `json:"timeStamp"`
		*AmfEventReportAlias
	...
	v.value.TimeStamp = time.Unix(alias.TimeStamp, 0)
	return nil

	// basic way produces parsing error
	// return json.Unmarshal(src, &v.value)
}

// Unmarshaling of the Report with timestamp. This method is called by json.Unmarshal
func (v *AmfEventReport) UnmarshalJSON(src []byte) error {
	// custom unmarshaling for timestamp: int64 (as used in AMF) => time.Time
	type AmfEventReportAlias AmfEventReport
	alias := &struct {
		TimeStamp int64 `json:"timeStamp"`
		*AmfEventReportAlias
		...
		AmfEventReportAlias: (*AmfEventReportAlias)(v),
	}
	err := json.Unmarshal(src, alias)
	if err != nil {
		return err
	}
	v.TimeStamp = time.Unix(alias.TimeStamp, 0)
	return nil

...
// AssertIpv6AddrRmRequired checks if the required fields are not zero-ed
func AssertIpv6AddrRmRequired(obj Ipv6AddrRm) error {
	return nil
}

// AssertIpv6AddrRmConstraints checks if the values respects the defined constraints
func AssertIpv6AddrRmConstraints(obj Ipv6AddrRm) error {
	return nil
}

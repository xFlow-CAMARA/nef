...
// AssertMutingNotificationsSettingsConstraints checks if the values respects the defined constraints
func AssertMutingNotificationsSettingsConstraints(obj MutingNotificationsSettings) error {
	return nil
}

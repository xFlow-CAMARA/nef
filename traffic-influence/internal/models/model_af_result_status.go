...
// AfResultStatus - Represents the status of application handling result.   Possible values are: - SUCCESS: The application layer is ready or the relocation is completed. - TEMPORARY_CONGESTION: The application relocation fails due to temporary congestion. - RELOC_NO_ALLOWED: The application relocation fails because application relocation   is not allowed. - OTHER: The application relocation fails due to other reason.
type AfResultStatus string

// AssertAfResultStatusRequired checks if the required fields are not zero-ed
func AssertAfResultStatusRequired(obj AfResultStatus) error {
	return nil
}

// AssertAfResultStatusConstraints checks if the values respects the defined constraints
func AssertAfResultStatusConstraints(obj AfResultStatus) error {
	return nil
}

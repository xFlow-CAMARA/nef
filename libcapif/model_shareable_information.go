...
type _ShareableInformation ShareableInformation
...
func (o *ShareableInformation) UnmarshalJSON(data []byte) (err error) {
	...
	varShareableInformation := _ShareableInformation{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varShareableInformation)

	if err != nil {
		return err
	}

	*o = ShareableInformation(varShareableInformation)

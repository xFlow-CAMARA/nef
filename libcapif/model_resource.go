...
func NewResource(resourceName string, commType string, uri string) *Resource {
	this := Resource{}
...
func (o *Resource) GetCommType() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *Resource) GetCommTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Resource) SetCommType(v string) {
	o.CommType = v
}
...
func (o *Resource) GetOperations() []string {
...
// and a boolean to check if the value has been set.
func (o *Resource) GetOperationsOk() ([]string, bool) {
	if o == nil || IsNil(o.Operations) {
		return nil, false
	}
...
func (o *Resource) SetOperations(v []string) {
	o.Operations = v
}

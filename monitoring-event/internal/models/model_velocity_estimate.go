...
// AssertVelocityEstimateConstraints checks if the values respects the defined constraints
func AssertVelocityEstimateConstraints(obj VelocityEstimate) error {
	if obj.HSpeed < 0 {

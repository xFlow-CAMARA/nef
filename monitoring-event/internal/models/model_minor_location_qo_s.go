...
// AssertMinorLocationQoSRequired checks if the required fields are not zero-ed
func AssertMinorLocationQoSRequired(obj MinorLocationQoS) error {
	return nil
}

// AssertMinorLocationQoSConstraints checks if the values respects the defined constraints
func AssertMinorLocationQoSConstraints(obj MinorLocationQoS) error {
	if obj.HAccuracy < 0 {

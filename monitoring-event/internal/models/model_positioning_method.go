...
// AssertPositioningMethodConstraints checks if the values respects the defined constraints
func AssertPositioningMethodConstraints(obj PositioningMethod) error {
	return nil
}

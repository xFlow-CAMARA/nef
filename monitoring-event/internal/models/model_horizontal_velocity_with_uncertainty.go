...
// AssertHorizontalVelocityWithUncertaintyConstraints checks if the values respects the defined constraints
func AssertHorizontalVelocityWithUncertaintyConstraints(obj HorizontalVelocityWithUncertainty) error {
	if obj.HSpeed < 0 {

...
type MediaComponentRm struct {
	...
	// This data type is defined in the same way as the 'BitRate' data type, but with the OpenAPI 'nullable: true' property.
	MaxSuppBwDl NullableString `json:"maxSuppBwDl,omitempty" validate:"regexp=^\\\\d+(\\\\.\\\\d+)? (bps|Kbps|Mbps|Gbps|Tbps)$"`
	// This data type is defined in the same way as the 'BitRate' data type, but with the OpenAPI 'nullable: true' property.
	MaxSuppBwUl NullableString `json:"maxSuppBwUl,omitempty" validate:"regexp=^\\\\d+(\\\\.\\\\d+)? (bps|Kbps|Mbps|Gbps|Tbps)$"`
	...
	// This data type is defined in the same way as the 'BitRate' data type, but with the OpenAPI 'nullable: true' property.
	MinDesBwDl NullableString `json:"minDesBwDl,omitempty" validate:"regexp=^\\\\d+(\\\\.\\\\d+)? (bps|Kbps|Mbps|Gbps|Tbps)$"`
	// This data type is defined in the same way as the 'BitRate' data type, but with the OpenAPI 'nullable: true' property.
	MinDesBwUl NullableString `json:"minDesBwUl,omitempty" validate:"regexp=^\\\\d+(\\\\.\\\\d+)? (bps|Kbps|Mbps|Gbps|Tbps)$"`
	// This data type is defined in the same way as the 'BitRate' data type, but with the OpenAPI 'nullable: true' property.
	MirBwDl NullableString `json:"mirBwDl,omitempty" validate:"regexp=^\\\\d+(\\\\.\\\\d+)? (bps|Kbps|Mbps|Gbps|Tbps)$"`
	// This data type is defined in the same way as the 'BitRate' data type, but with the OpenAPI 'nullable: true' property.
	MirBwUl        NullableString                  `json:"mirBwUl,omitempty" validate:"regexp=^\\\\d+(\\\\.\\\\d+)? (bps|Kbps|Mbps|Gbps|Tbps)$"`
	PreemptCap     NullablePreemptionCapability    `json:"preemptCap,omitempty"`
	PreemptVuln    NullablePreemptionVulnerability `json:"preemptVuln,omitempty"`
	PrioSharingInd *PrioritySharingIndicator       `json:"prioSharingInd,omitempty"`
	ResPrio        *ReservPriority                 `json:"resPrio,omitempty"`
	// This data type is defined in the same way as the 'BitRate' data type, but with the OpenAPI 'nullable: true' property.
	RrBw NullableString `json:"rrBw,omitempty" validate:"regexp=^\\\\d+(\\\\.\\\\d+)? (bps|Kbps|Mbps|Gbps|Tbps)$"`
	// This data type is defined in the same way as the 'BitRate' data type, but with the OpenAPI 'nullable: true' property.
	RsBw NullableString `json:"rsBw,omitempty" validate:"regexp=^\\\\d+(\\\\.\\\\d+)? (bps|Kbps|Mbps|Gbps|Tbps)$"`
	...
	PduSetQosDl  NullablePduSetQosPara `json:"pduSetQosDl,omitempty"`
	PduSetQosUl  NullablePduSetQosPara `json:"pduSetQosUl,omitempty"`
...
type _MediaComponentRm MediaComponentRm
...
// GetPreemptCap returns the PreemptCap field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *MediaComponentRm) GetPreemptCap() PreemptionCapability {
	if o == nil || IsNil(o.PreemptCap.Get()) {
		var ret PreemptionCapability
		return ret
	}
	return *o.PreemptCap.Get()
}

// GetPreemptCapOk returns a tuple with the PreemptCap field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *MediaComponentRm) GetPreemptCapOk() (*PreemptionCapability, bool) {
	if o == nil {
		return nil, false
	}
	return o.PreemptCap.Get(), o.PreemptCap.IsSet()
}

// HasPreemptCap returns a boolean if a field has been set.
func (o *MediaComponentRm) HasPreemptCap() bool {
	if o != nil && o.PreemptCap.IsSet() {
		return true
	}
...
// SetPreemptCap gets a reference to the given NullablePreemptionCapability and assigns it to the PreemptCap field.
func (o *MediaComponentRm) SetPreemptCap(v PreemptionCapability) {
	o.PreemptCap.Set(&v)
}

// SetPreemptCapNil sets the value for PreemptCap to be an explicit nil
func (o *MediaComponentRm) SetPreemptCapNil() {
	o.PreemptCap.Set(nil)
}

// UnsetPreemptCap ensures that no value is present for PreemptCap, not even an explicit nil
func (o *MediaComponentRm) UnsetPreemptCap() {
	o.PreemptCap.Unset()
}

// GetPreemptVuln returns the PreemptVuln field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *MediaComponentRm) GetPreemptVuln() PreemptionVulnerability {
	if o == nil || IsNil(o.PreemptVuln.Get()) {
		var ret PreemptionVulnerability
		return ret
	}
	return *o.PreemptVuln.Get()
}

// GetPreemptVulnOk returns a tuple with the PreemptVuln field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *MediaComponentRm) GetPreemptVulnOk() (*PreemptionVulnerability, bool) {
	if o == nil {
		return nil, false
	}
	return o.PreemptVuln.Get(), o.PreemptVuln.IsSet()
}

// HasPreemptVuln returns a boolean if a field has been set.
func (o *MediaComponentRm) HasPreemptVuln() bool {
	if o != nil && o.PreemptVuln.IsSet() {
		return true
	}
...
// SetPreemptVuln gets a reference to the given NullablePreemptionVulnerability and assigns it to the PreemptVuln field.
func (o *MediaComponentRm) SetPreemptVuln(v PreemptionVulnerability) {
	o.PreemptVuln.Set(&v)
}

// SetPreemptVulnNil sets the value for PreemptVuln to be an explicit nil
func (o *MediaComponentRm) SetPreemptVulnNil() {
	o.PreemptVuln.Set(nil)
}

// UnsetPreemptVuln ensures that no value is present for PreemptVuln, not even an explicit nil
func (o *MediaComponentRm) UnsetPreemptVuln() {
	o.PreemptVuln.Unset()
}
...
func (o *MediaComponentRm) GetPduSetQosDl() PduSetQosPara {
	if o == nil || IsNil(o.PduSetQosDl.Get()) {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *MediaComponentRm) GetPduSetQosDlOk() (*PduSetQosPara, bool) {
	if o == nil {
		return nil, false
	}
...
// SetPduSetQosDl gets a reference to the given NullablePduSetQosPara and assigns it to the PduSetQosDl field.
func (o *MediaComponentRm) SetPduSetQosDl(v PduSetQosPara) {
	o.PduSetQosDl.Set(&v)
}
...
func (o *MediaComponentRm) GetPduSetQosUl() PduSetQosPara {
	if o == nil || IsNil(o.PduSetQosUl.Get()) {
		var ret PduSetQosPara
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *MediaComponentRm) GetPduSetQosUlOk() (*PduSetQosPara, bool) {
	if o == nil {
		return nil, false
	}
...
// SetPduSetQosUl gets a reference to the given NullablePduSetQosPara and assigns it to the PduSetQosUl field.
func (o *MediaComponentRm) SetPduSetQosUl(v PduSetQosPara) {
	o.PduSetQosUl.Set(&v)
}
...
func (o MediaComponentRm) ToMap() (map[string]interface{}, error) {
	...
	if o.PreemptCap.IsSet() {
		toSerialize["preemptCap"] = o.PreemptCap.Get()
	}
	if o.PreemptVuln.IsSet() {
		toSerialize["preemptVuln"] = o.PreemptVuln.Get()
	}
...
func (o *MediaComponentRm) UnmarshalJSON(data []byte) (err error) {
	...
	varMediaComponentRm := _MediaComponentRm{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMediaComponentRm)

	if err != nil {
		return err
	}

	*o = MediaComponentRm(varMediaComponentRm)

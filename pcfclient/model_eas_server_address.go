...
type _EasServerAddress EasServerAddress
...
func (o *EasServerAddress) UnmarshalJSON(data []byte) (err error) {
	...
	varEasServerAddress := _EasServerAddress{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEasServerAddress)

	if err != nil {
		return err
	}

	*o = EasServerAddress(varEasServerAddress)

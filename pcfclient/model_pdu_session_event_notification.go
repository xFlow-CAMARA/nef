...
type PduSessionEventNotification struct {
	...
	UeIpv4 *string   `json:"ueIpv4,omitempty" validate:"regexp=^(([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\\\\.){3}([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])$"`
...
type _PduSessionEventNotification PduSessionEventNotification
...
func (o *PduSessionEventNotification) UnmarshalJSON(data []byte) (err error) {
	...
	varPduSessionEventNotification := _PduSessionEventNotification{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPduSessionEventNotification)

	if err != nil {
		return err
	}

	*o = PduSessionEventNotification(varPduSessionEventNotification)

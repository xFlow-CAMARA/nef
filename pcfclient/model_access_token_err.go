...
type _AccessTokenErr AccessTokenErr
...
func (o *AccessTokenErr) UnmarshalJSON(data []byte) (err error) {
	...
	varAccessTokenErr := _AccessTokenErr{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAccessTokenErr)

	if err != nil {
		return err
	}

	*o = AccessTokenErr(varAccessTokenErr)

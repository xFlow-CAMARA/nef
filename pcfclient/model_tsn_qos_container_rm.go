...
type TsnQosContainerRm struct {
	...
	MaxPer NullableString `json:"maxPer,omitempty" validate:"regexp=^([0-9]E-[0-9])$"`
...
// SetMaxPer gets a reference to the given NullableString and assigns it to the MaxPer field.

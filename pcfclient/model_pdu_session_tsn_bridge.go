...
type _PduSessionTsnBridge PduSessionTsnBridge
...
func (o *PduSessionTsnBridge) UnmarshalJSON(data []byte) (err error) {
	...
	varPduSessionTsnBridge := _PduSessionTsnBridge{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPduSessionTsnBridge)

	if err != nil {
		return err
	}

	*o = PduSessionTsnBridge(varPduSessionTsnBridge)

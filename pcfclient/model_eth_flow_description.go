...
type _EthFlowDescription EthFlowDescription
...
func (o *EthFlowDescription) UnmarshalJSON(data []byte) (err error) {
	...
	varEthFlowDescription := _EthFlowDescription{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEthFlowDescription)

	if err != nil {
		return err
	}

	*o = EthFlowDescription(varEthFlowDescription)

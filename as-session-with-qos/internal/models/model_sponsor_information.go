...
// AssertSponsorInformationRequired checks if the required fields are not zero-ed
func AssertSponsorInformationRequired(obj SponsorInformation) error {
...
// AssertSponsorInformationConstraints checks if the values respects the defined constraints
func AssertSponsorInformationConstraints(obj SponsorInformation) error {
	return nil
}

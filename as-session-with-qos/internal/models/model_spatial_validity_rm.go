...
// AssertSpatialValidityRmRequired checks if the required fields are not zero-ed
func AssertSpatialValidityRmRequired(obj SpatialValidityRm) error {
...
// AssertSpatialValidityRmConstraints checks if the values respects the defined constraints
func AssertSpatialValidityRmConstraints(obj SpatialValidityRm) error {
	return nil
}

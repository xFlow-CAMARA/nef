...
// AssertAccumulatedUsageRequired checks if the required fields are not zero-ed
func AssertAccumulatedUsageRequired(obj AccumulatedUsage) error {
	return nil
}

// AssertAccumulatedUsageConstraints checks if the values respects the defined constraints
func AssertAccumulatedUsageConstraints(obj AccumulatedUsage) error {
	if obj.Duration < 0 {
